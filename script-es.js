...
function setupAppScreenshot() {
  ...
  ctx.fillText('Escáner LEGO', 60, 110);
  ctx.font = '12px sans-serif';
  ctx.fillText('Tomar una foto', 40, 200);
  ctx.fillText('Analizar piezas', 40, 220);
  
  // Convert to data URL and set as src
  appScreenshot.src = canvas.toDataURL();
  appScreenshot.alt = 'Interfaz de la aplicación Brick Scanner';
}
