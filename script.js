...
const translations = {
  fr: {
    ...
    heroTitle: "Scannez vos LEGO,<br><span class='gradient-text'>construisez vos rêves</span>",
    heroSubtitle: "Photographiez vos pièces LEGO et découvrez instantanément tous les sets que vous pouvez construire avec notre IA de reconnaissance intelligente.",
    downloadOn: "Télécharger sur",
    getItOn: "Disponible sur",
    statDownloads: "Téléchargements",
    statAccuracy: "Précision",
    statSets: "Sets détectés",
    howItWorksTitle: "Comment ça marche",
    howItWorksSubtitle: "Trois étapes simples pour découvrir ce que vous pouvez construire",
    step1Title: "1. Photographiez",
    step1Desc: "Prenez une photo de vos pièces LEGO éparpillées sur une surface claire",
    step2Title: "2. IA analyse",
    step2Desc: "Notre intelligence artificielle identifie et classe chaque pièce en quelques secondes",
    step3Title: "3. Construisez",
    step3Desc: "Découvrez tous les sets possibles et suivez les instructions de montage",
    featuresTitle: "Pourquoi choisir Brick Scanner ?",
    feature1Title: "Reconnaissance précise",
    feature1Desc: "99% de précision dans l'identification des pièces LEGO grâce à notre IA avancée",
    feature2Title: "Base de données complète",
    feature2Desc: "Plus de 10 000 sets LEGO référencés avec instructions détaillées",
    feature3Title: "Interface intuitive",
    feature3Desc: "Application simple et élégante, conçue pour tous les âges",
    feature4Title: "Résultats instantanés",
    feature4Desc: "Analyses en temps réel, résultats en moins de 3 secondes",
    testimonialsTitle: "Ce que disent nos utilisateurs",
    testimonial1: "\"Incroyable ! J'ai redécouvert mes vieux LEGO grâce à cette app. Mes enfants sont ravis de construire de nouveaux sets.\"",
    testimonial1Role: "Maman de 2 enfants",
    testimonial2: "\"La reconnaissance est bluffante ! Même avec des pièces mélangées de différentes couleurs, l'app trouve toujours des constructions possibles.\"",
    testimonial2Role: "Collectionneur LEGO",
    testimonial3: "\"Parfait pour organiser ma collection LEGO ! La reconnaissance IA est incroyablement précise et rapide.\"",
    testimonial3Role: "Passionné LEGO",
    ctaTitle: "Prêt à redécouvrir vos LEGO ?",
    ctaSubtitle: "Téléchargez Brick Scanner dès maintenant et commencez votre aventure",
    footerDesc: "L'application qui révolutionne votre expérience LEGO",
    footerContactTitle: "Contact",
    footerLegalTitle: "Légal",
    footerPrivacy: "Politique de confidentialité",
    footerRights: "Tous droits réservés.",
    footerDisclaimer: "LEGO® est une marque déposée du groupe LEGO. Cette application n'est pas affiliée à LEGO.",
    modalTitle: "Comment fonctionne Brick Scanner",
    modalStep1: "Photographiez vos pièces",
    modalStep1Desc: "Disposez vos pièces LEGO sur une surface claire et prenez une photo avec votre smartphone",
    modalStep2: "Analyse IA instantanée",
    modalStep2Desc: "Notre intelligence artificielle avancée analyse et identifie chaque pièce en temps réel",
    modalStep3: "Découvrez les possibilités",
    modalStep3Desc: "Explorez tous les sets que vous pouvez construire avec des instructions détaillées"
  },
  en: {
    ...
    footerDisclaimer: "LEGO® is a trademark of the LEGO Group. This app is not affiliated with LEGO.",
  ...
  es: {
    ...
    download: "Descargar",
    heroTitle: "Escanea tus LEGO,<br><span class='gradient-text'>construye tus sueños</span>",
    heroSubtitle: "Fotografía tus piezas LEGO y descubre instantáneamente todos los sets que puedes construir con nuestra IA de reconocimiento inteligente.",
    ...
    howItWorksSubtitle: "Tres pasos simples para descubrir qué puedes construir",
    step1Title: "1. Fotografía",
    ...
    step3Desc: "Descubre todos los sets posibles y sigue las instrucciones de construcción",
    featuresTitle: "¿Por qué elegir Brick Scanner?",
    feature1Title: "Reconocimiento preciso",
    feature1Desc: "99% de precisión en la identificación de piezas LEGO gracias a nuestra IA avanzada",
    feature2Title: "Base de datos completa",
    feature2Desc: "Más de 10,000 sets LEGO referenciados con instrucciones detalladas",
    feature3Title: "Interfaz intuitiva",
    feature3Desc: "Aplicación simple y elegante, diseñada para todas las edades",
    feature4Title: "Resultados instantáneos",
    feature4Desc: "Análisis en tiempo real, resultados en menos de 3 segundos",
    testimonialsTitle: "Lo que dicen nuestros usuarios",
    testimonial1: "\"¡Increíble! Redescubrí mis viejos LEGO gracias a esta app. Mis hijos están encantados de construir nuevos sets.\"",
    testimonial1Role: "Mamá de 2 niños",
    ...
    testimonial3: "\"¡Perfecto para organizar mi colección LEGO! El reconocimiento IA es increíblemente preciso y rápido.\"",
    testimonial3Role: "Entusiasta LEGO",
    ctaTitle: "¿Listo para redescubrir tus LEGO?",
    ctaSubtitle: "Descarga Brick Scanner ahora y comienza tu aventura",
    footerDesc: "La aplicación que revoluciona tu experiencia LEGO",
    footerContactTitle: "Contacto",
    footerLegalTitle: "Legal",
    footerPrivacy: "Política de Privacidad",
    footerRights: "Todos los derechos reservados.",
    footerDisclaimer: "LEGO® es una marca registrada del Grupo LEGO. Esta aplicación no está afiliada a LEGO.",
    modalTitle: "Cómo funciona Brick Scanner",
    modalStep1: "Fotografía tus piezas",
    modalStep1Desc: "Coloca tus piezas LEGO en una superficie clara y toma una foto con tu smartphone",
    modalStep2: "Análisis IA instantáneo",
